...
LOCK_JSON='{
  "title": {"repository":"iceqi/xymedia-components","tag":"title-component-sha-ab7f33d6ede5","release_version":"sha-ab7f33d6ede5","assets":{"linux/amd64":{"name":"xymedia-title-sha-ab7f33d6ede5-linux-amd64.tar.zst","platform":"linux/amd64","sha256":"201443ee5b61a447ed4edb551d23a57bde2f6bfb68520d2891c6cd66f0fb2b1f"},"linux/arm64":{"name":"xymedia-title-sha-ab7f33d6ede5-linux-arm64.tar.zst","platform":"linux/arm64","sha256":"4c44936d1d63052701e55a52b00e4909c903e766158d62d4ad6097170d23e56a"}}},
  "tmm": {"repository":"iceqi/xymedia-components","tag":"tmm-component-sha-a0206a51fd9e","release_version":"sha-a0206a51fd9e","assets":{"linux/amd64":{"name":"xymedia-tmm-sha-a0206a51fd9e-linux-any.tar.zst","platform":"linux/any","sha256":"57ee0cdf0cf2127678ab598dfb8e9047e6aa903443f8d616955533e6cca0cfea"},"linux/arm64":{"name":"xymedia-tmm-sha-a0206a51fd9e-linux-any.tar.zst","platform":"linux/any","sha256":"57ee0cdf0cf2127678ab598dfb8e9047e6aa903443f8d616955533e6cca0cfea"}}}
}'
...
lock_query='type == "object" and (keys|sort == ["title","tmm"]) and all(.[]; (.repository == "iceqi/xymedia-components") and (.tag|type=="string") and (.release_version|type=="string" and test("^sha-[0-9a-f]{12}$")) and (.assets|type=="object") and all(.assets[]; (.name|type=="string" and test("^[A-Za-z0-9._-]+\\.tar\\.zst$")) and (.platform|type=="string" and test("^linux/(amd64|arm64|any)$")) and (.sha256|type=="string" and test("^[0-9a-fA-F]{64}$")))) and (.title.tag|test("^title-component-sha-[0-9a-f]{12}$")) and (.tmm.tag|test("^tmm-component-sha-[0-9a-f]{12}$"))'
